 ...
 * object, but one that does a better job of distributing students in a hash
 * table.
 * 
 * @author Erin Parker & Jaxson Goeckeritz & Kaden Baskett
 * @version ?
 */
public class StudentMediumHash {
	...
	public int hashCode() {
		...
		return lastName.hashCode() * firstName.hashCode() * uid;
	}
}